...
public class PanelController4Admin {
    ...
    //http://localhost:9999/admin/panel/hotsearch/add
    ...
    //http://localhost:9999/admin/panel/hotsearch/delete
    ...
    //http://localhost:9999/admin/panel/hotsearch/clear
    ...
    //http://localhost:9999/admin/panel/hotsearch/query/page
    ...
    //http://localhost:9999/admin/panel/rotation/add
    ...
    //http://localhost:9999/admin/panel/rotation/delete
    ...
    //http://localhost:9999/admin/panel/rotation/query/page
    ...
    //http://localhost:9999/admin/panel/upshow/add
    ...
    //http://localhost:9999/admin/panel/upshow/delete
    ...
    //http://localhost:9999/admin/panel/upshow/query/page
