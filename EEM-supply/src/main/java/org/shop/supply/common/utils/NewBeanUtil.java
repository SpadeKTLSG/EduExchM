...
import org.shop.supply.entity.remote.User;
...
public class NewBeanUtil {
    ...
    /**
     * 自制Prod DTO - Service映射服务
     */
    public static <T> void prodDtoMapService(Map<Object, IService> dtoServiceMap, Long id, Optional<T> optionalProd) {
