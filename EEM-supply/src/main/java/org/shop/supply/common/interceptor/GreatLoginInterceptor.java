...
import org.shop.supply.common.context.EmployeeHolder;
import org.shop.supply.common.context.UserHolder;
import org.shop.supply.entity.remote.EmployeeLocalDTO;
import org.shop.supply.entity.remote.UserLocalDTO;
    ...
    public boolean preHandle(HttpServletRequest request, @NotNull HttpServletResponse response, @NotNull Object handler) {
        ...
        if (feign_info != null) {
            ...
            if (Objects.equals(user_type, "admin")) {
                log.debug("OpenFeign操作EEM-supply管理员: " + feign_info);
                ...
                log.debug("OpenFeign操作EEM-supply用户: " + feign_info);
