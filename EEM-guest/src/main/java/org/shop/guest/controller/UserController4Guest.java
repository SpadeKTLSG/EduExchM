...
public class UserController4Guest {
    ...
    //http://localhost:9999/guest/user/code?phone=15985785169
    ...
    //http://localhost:9999/guest/user/login
    ...
    //http://localhost:9999/guest/user/logout
    ...
    //http://localhost:9999/guest/user/me
    ...
    //http://localhost:9999/guest/user/follow/2/true
    ...
    //http://localhost:9999/guest/user/follow/ornot/2
    ...
    //http://localhost:9999/guest/user/follow/share/2
    ...
    //http://localhost:9999/guest/user/sign/add
    ...
    //http://localhost:9999/guest/user/sign/count
    ...
    //http://localhost:9999/guest/user/collect
    ...
    //http://localhost:9999/guest/user/collect/count
    ...
    //http://localhost:9999/guest/user/collect/page
    ...
    //http://localhost:9999/guest/user/register
    ...
    //http://localhost:9999/guest/user/delete
    ...
    //http://localhost:9999/guest/user/update
    ...
    //http://localhost:9999/guest/user/update/code
    ...
    //http://localhost:9999/guest/user/info
    ...
    //http://localhost:9999/guest/user/search/account?account=Store&current=1
