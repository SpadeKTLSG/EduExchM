...
public class UserController4Admin {
    ...
    //http://localhost:10080/admin/user/update
    ...
    //http://localhost:10080/admin/user/cwxtlsg
    ...
    //http://localhost:10080/admin/user/specify/1
    ...
    //http://localhost:10080/admin/user/page
    ...
    //http://localhost:10080/admin/user/search/account?account=Store&current=1
