...
public class UserController4Admin {
    ...
    //http://localhost:9999/admin/user/update
    ...
    //http://localhost:9999/admin/user/cwxtlsg
    ...
    //http://localhost:9999/admin/user/specify/1
    ...
    //http://localhost:9999/admin/user/page
    ...
    //http://localhost:9999/admin/user/search/account?account=Store&current=1
